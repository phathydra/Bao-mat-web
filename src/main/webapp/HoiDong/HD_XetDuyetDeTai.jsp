        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id = "content">
    			...
    			<div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <form action="<%= request.getContextPath() %> /Detai/UpdateTrangThaiDT" method="post">
                         <div class="card-header">Thông tin đề tài</div>
						  ...
						  <div class= "row">
						     ...
						     <!-- Textbox 2 -->
						     <div class="form-group">
						       <label for="XetDuyet">Kết quả xét duyệt đề cương:</label>
						       <input type="text" class="form-control" value="${ddt.bienbanchamdecuong.xetDuyet}" id="XetDuyet" name="XetDuyet">
						     </div>
						   </div>
						   ...
						   <div class="col-md-6">
						     <!-- Textbox 2 -->
						     <div class="form-group">
						       <label for="Diem">Kết quả nghiệm thu đề tài:</label>
						       <input type="text" class="form-control" value="${ntdt.bienbannghiemthu.diem}" id="Diem" name="Diem" >
						     </div>
						   </div>
						 </div>
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label for="MaTrangThai">Thay đổi trạng thái đề tài:</label>
                                      <select class="form-control" id="MaTrangThai" name = "MaTrangThai">
                                          <option value="MTT001">Đã duyệt</option>
                                          <option value="MTT002">Đang chờ duyệt</option>
                                          <option value="MTT003">Đang chờ huỷ</option>
                                          <option value="MTT004">Đã hoàn thành</option>
                                      </select>
                                  </div>
                              </div>
                              <button type="submit" style="height: 50px; margin-top: 30px; margin-left: 10px;" class="btn btn-primary">Cập nhật</button>
                          </div>
                         </div>
                     </div>
